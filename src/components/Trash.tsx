  ...
  return (
    <section className="flex flex-col items-center text-foreground text-xl font-semibold py-8">
      <ul className="w-full max-w-[1024px] flex flex-col gap-y-1">
        <li className="flex text-wrap gap-x-8 justify-between bg-background px-4 py-2 hover:bg-foreground hover:text-background transition-all ease-out">
          <span>Trash</span>
        </li>
        <li>
          <a
            ...
            target="_blank"
            className="flex text-wrap gap-x-8 justify-between bg-background px-4 py-2 hover:bg-foreground hover:text-background transition-all ease-out"
          >
        ...
        <li>
          ...
          >
            ...
            <span className="hidden sm:block">2023</span>
          </a>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span className="hidden sm:block">2022</span>
          </a>
        </li>
      </ul>
    </section>
